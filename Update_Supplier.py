...
class UpdateSupplier:
    def __init__(self,root):
        ...
        supplierId = CTkComboBox(master = frame, values=suppliers, width=300, height=50, fg_color="#FFFFFF", text_color="#000000", button_color="#00FFFF", font=("Arial", 20), corner_radius=40)
        ...
        add_order_button = CTkButton(master=frame, width=20, height=30, text="UPDATE", font=("Arial", 40, 'bold'), fg_color="#FFA502", text_color="#000000", corner_radius=40)
        
        search = CTkButton(master=frame, width=20, height=30, text="Search", font=("Arial", 30, 'bold'), fg_color="#3742FA", text_color="#000000", corner_radius=40)
